...
public class UsuarioEstadoRecibidasAdapter extends ArrayAdapter<UsuarioEstado> implements Filterable {
    ...
    public UsuarioEstadoRecibidasAdapter(@NonNull Context _context, int _resource, @NonNull List <UsuarioEstado> _objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        FloatingActionButton botonAceptar = (FloatingActionButton) view.findViewById(R.id.botonAceptarSoli);
        FloatingActionButton botonCancelar = (FloatingActionButton) view.findViewById(R.id.botonCancelarSoli);
    ...
    private void peticionAmistadAccept(int id, FloatingActionButton botonAceptar, FloatingActionButton botonCancelar){
        ...
        llamada.enqueue(new Callback<GenericMessageResult>() {
            ...
            public void onResponse(Call<GenericMessageResult> call, Response<GenericMessageResult> response) {
                ...
                if(response.code() == 200) {
                    ...
                    botonAceptar.setClickable(false);
    ...
    private void peticionAmistadReject(int id, FloatingActionButton botonAceptar, FloatingActionButton botonCancelar){
        GenericOtherIdRequest request = new GenericOtherIdRequest(id);
